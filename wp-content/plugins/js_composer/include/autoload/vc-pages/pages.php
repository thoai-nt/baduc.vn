...
function vc_menu_page_build() {
	...
	add_menu_page( esc_html__( 'The7 WPBakery Page Builder', 'js_composer' ), esc_html__( 'The7 WPBakery Page Builder', 'js_composer' ), 'edit_posts', VC_PAGE_MAIN_SLUG, null, vc_asset_url( 'vc/logo/wpb-logo-white_32.svg' ), 76 );
...
function vc_network_menu_page_build() {
	...
	add_menu_page( esc_html__( 'The7 WPBakery Page Builder', 'js_composer' ), esc_html__( 'The7 WPBakery Page Builder', 'js_composer' ), 'exist', VC_PAGE_MAIN_SLUG, null, vc_asset_url( 'vc/logo/wpb-logo-white_32.svg' ), 76 );
