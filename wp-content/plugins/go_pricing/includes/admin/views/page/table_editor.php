...
if ( !empty( $postid ) && empty( $table_data ) ) {
    $table_data = GW_GoPricing_Data::get_table( $postid );
}
...
?>
						...
						<table class="gwa-table">
							<tr>
								<th><label><?php _e( 'Tooltip Positon', 'go_pricing_textdomain' );?> </label></th>
								<td>
									<select name="tooltip[position]">
										<option value="top-right"<?php echo isset( $table_data['tooltip']['position'] ) && $table_data['tooltip']['position'] == 'top-right' ? ' selected="selected"' : ''; ?>><?php esc_html_e( 'Top Right', 'go_pricing_textdomain' );?></option>
										<option value="top-center"<?php echo isset( $table_data['tooltip']['position'] ) && $table_data['tooltip']['position'] == 'top-center' ? ' selected="selected"' : ''; ?>><?php esc_html_e( 'Top Center', 'go_pricing_textdomain' );?></option>
										<option value="top-left"<?php echo isset( $table_data['tooltip']['position'] ) && $table_data['tooltip']['position'] == 'top-left' ? ' selected="selected"' : ''; ?>><?php esc_html_e( 'Top Left', 'go_pricing_textdomain' );?></option>
									</select>
								</td>
								<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Position of the tooltip.', 'go_pricing_textdomain' );?></p></td>
							</tr>
					...
					<div class="gwa-abox-content">
						...
						<div class="go-pricing-cols-wrap">
							<div class="go-pricing-cols gwa-clearfix">
								<!-- Columns -->
								<?php if ( !empty( $table_data['col-data'] ) ) {
